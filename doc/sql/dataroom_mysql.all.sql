...
(
    ...
    `data_source`      LONGTEXT     DEFAULT NULL COMMENT '数据源配置',
...
(
    ...
    `dataset`          LONGTEXT     DEFAULT NULL COMMENT '数据集配置',
    `input_list`       LONGTEXT     DEFAULT NULL COMMENT '入参列表',
    `output_list`      LONGTEXT     DEFAULT NULL COMMENT '出参列表',
    `create_date`      DATETIME     DEFAULT NULL COMMENT '创建时间',
    `create_user`      VARCHAR(50)  DEFAULT NULL COMMENT '创建人',
    `update_date`      DATETIME     DEFAULT NULL COMMENT '更新时间',
    `update_user`      VARCHAR(50)  DEFAULT NULL COMMENT '更新人',
...
(
    ...
    `page_config` LONGTEXT     DEFAULT NULL COMMENT '页面配置',
    `create_date` DATETIME     DEFAULT NULL COMMENT '创建时间',
    `create_user` VARCHAR(50)  DEFAULT NULL COMMENT '创建人',
    `update_date` DATETIME     DEFAULT NULL COMMENT '更新时间',
    `update_user` VARCHAR(50)  DEFAULT NULL COMMENT '更新人',
...
(
    ...
    `config`        LONGTEXT     DEFAULT NULL COMMENT '模型个性化配置（JSON）',
    `create_date`   DATETIME     DEFAULT NULL COMMENT '创建时间',
    `create_user`   VARCHAR(50)  DEFAULT NULL COMMENT '创建人',
    `update_date`   DATETIME     DEFAULT NULL COMMENT '更新时间',
    `update_user`   VARCHAR(50)  DEFAULT NULL COMMENT '更新人',
